...
class TestCSVWriter(unittest.TestCase):
    ...
    def test_append_support_manager_yes_customer(self):
        ...
        row_vals = rows[1]
        self.assertEqual(len(row_vals), 15)
        ...
        self.assertEqual(row_vals[6], "2021-01-01")  # Signed Up Date
        self.assertEqual(row_vals[7], "2021-01-15")  # Live Date
        self.assertEqual(row_vals[14], "No")  # isD2C (no email provided)

    def test_append_customer_support_manager_no(self):
        cust_data = {
        ...
        self.assertEqual(row_vals[10], "9876543210")  # Mobile Number
        self.assertEqual(row_vals[11], "9876543211")  # Registered Mobile Number
    ...
    def test_append_customer_sequential_sr_no(self):
        seller1 = {
        ...
        # Total rows = 1 header + 1 for Seller 1 + 1 for Seller 2 = 3 rows
        ...
        self.assertEqual(rows[1][9], "3")

        # Row 2: Seller 2, Sr No 2
        self.assertEqual(rows[2][0], "2")
        self.assertEqual(rows[2][1], "SELLER_2")
        self.assertEqual(rows[2][2], "Single Brand Seller")
        self.assertEqual(rows[2][9], "1")
