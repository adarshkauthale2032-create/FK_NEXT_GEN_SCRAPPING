...
class TestExcelWriter25Columns(unittest.TestCase):
    ...
    def test_format_customer_rows_25_columns_with_instagram_followers(self):
        ...
        self.assertEqual(row[6], "Insta Plaza")                             # Address
        ...
        self.assertEqual(row[17], "https://www.instagram.com/instaseller_official/") # Instagram URL
        self.assertEqual(row[18], "125K")                                   # Instagram Followers
        self.assertEqual(row[23], "No")                                     # Unique Email
        self.assertEqual(row[24], "Yes")                                    # isD2C (Triggered by Instagram!)
